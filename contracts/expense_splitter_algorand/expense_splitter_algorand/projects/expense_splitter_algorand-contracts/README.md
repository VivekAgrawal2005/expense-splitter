# expense_splitter_algorand-contracts
...
By default the template creates a single `HelloWorld` contract under expense_splitter_contract folder in the `smart_contracts` directory. To add a new contract:
